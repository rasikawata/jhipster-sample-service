...
@RestController
@RequestMapping("/api/jhipster-sample-service-kafka")
public class JhipsterSampleServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterSampleServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSampleServiceKafkaResource(KafkaProperties kafkaProperties) {
