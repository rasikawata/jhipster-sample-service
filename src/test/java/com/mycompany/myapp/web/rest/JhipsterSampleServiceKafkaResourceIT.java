...
class JhipsterSampleServiceKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleServiceKafkaResource kafkaResource = new JhipsterSampleServiceKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sample-service-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sample-service-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
